...
import 'package:superapp/pages/recipe_detail_extra.dart';
import 'package:superapp/pages/recipe_detail_page.dart';

class RecipeTileExtra extends StatefulWidget {
  final Recipe? data;
  RecipeTileExtra({this.data});

  @override
  State<RecipeTileExtra> createState() => _RecipeTileExtraState();
}

class _RecipeTileExtraState extends State<RecipeTileExtra> {
    ...
    return GestureDetector(
      onTap: () async {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => RecipeDetailExtra(
                data: mealDetail!,
                missedIng: widget.data!.missedIngredients!,
                usedIng: widget.data!.usedIngredients!),
          ),
        );
      },
      child: Container(
